...
void Test_CF_GetMemcpySize_WhenGivenSizeIs_0_Given_num_ArrayValuesDoNotMatterAlwaysReturn_0(void)
{
    ...
    /* Assert */
    UtAssert_True(local_result == 0, "CF_GetMemcpySize returned %d and should be 0", local_result);
...
void Test_CF_GetMemcpySize_WhenGivenSizeIs_1_AndGiven_num_Uint8Is_0_Return_1(void)
{
    ...
    /* Assert */
    UtAssert_True(local_result == 1, "CF_GetMemcpySize returned %d and should be 1", local_result);
...
void Test_CF_GetMemcpySize_WhenGivenSizeIsAny_int_AndNumsAreAll_0_Return_1(void)
{
    ...
    int arg_size = Any_int_ZeroOrPositiveLessThan(200) + 1; /* Any_int_ZeroOrPositiveLessThan(200) + 1 gives 1 to 200 to
                                                               be under or eq arg_num defined size, but at least 1*/
    int local_result;
...
void Test_CF_GetMemcpySize_WhenGiven_num_ElementAtGiven_size_Minus_1_IsNot_0_ReturnValueOf_size(void)
{
    ...
    /* Assert */
    UtAssert_True(local_result == arg_size, "CF_GetMemcpySize returned %d and should be %d (size)", local_result,
                  arg_size);
} /* end Test_CF_GetMemcpySize_WhenGiven_num_ElementAtGiven_size_Minus_1_IsNot_0_ReturnValueOf_size */

void Test_CF_GetMemcpySize_WhenGiven_num_ElementsAre_0_FromGiven_size_UntilAnotherElementInArrayIsNonZeroReturnThatElementsIndexPlus_1(
    void)
{
    /* Arrange */
    uint8_t arg_num[200] = {0}; /* 200 for arg_num just an arbitrary value for speed of testing */
    int     arg_size     = Any_int_ZeroOrPositiveLessThan(199) +
                   2; /* Any_int_ZeroOrPositiveLessThan(199) + 2 gives 2 to 200 to be under or eq arg_num defined size,
                         but at least 2 because of behavior being tested */
    int local_result;
    ...
    UtAssert_True(local_result == dummy_num_element_index + 1,
                  "CF_GetMemcpySize returned %d and should be %d (location of first non 0 element)", local_result,
                  dummy_num_element_index + 1);
} /* end
...
/* NOTE:Test_CF_MemcpyToBE_Asserts_both_src_size_And_dst_size_AreNegative not required for coverage but desired for
 * completeness */
...
//     uint8 *     arg_dst;
//     uint8 *     arg_src;
//     int         arg_src_size = Any_int_ZeroOrPositiveLessThan(INT32_MAX - 2) + 1; /* -2 then +1 for 1 to INT32_MAX -
//     1 */ int         arg_dst_size = arg_src_size + 1; /* TODO change to any int greater than? DNE at time of writing
//     */
...
void Test_CF_MemcpyToBE_WhenBoth_src_size_And_dst_size_Eq_1_CopyOne_src_Value(void)
{
    ...
    /* Assert */
    UtAssert_True(arg_dst[0] == arg_src[0], "One value copied from arg_src to arg_dst");
...
void Test_CF_MemcpyToBE_When_dst_size_IsLessThan_src_size_CopyAllRequisite_src_ValuesInto_dst(void)
{
    ...
    int   arg_dst_size = Any_uint8_LessThan(arg_src_size - 1) +
                       1; /* Any_uint8_LessThan(arg_src_size - 1) + 1 give min of 1, max of 1 less than arg_src_size */
    uint8 i;
    ...
    for (i = 0; i < arg_dst_size; ++i)
    {
        UtAssert_True(arg_dst[arg_dst_size - i - 1] == arg_src[i],
                      "Correct value copied from arg_src[%u] (%u) to arg_dst[%u] (%u)", i, arg_src[i],
                      arg_dst_size - i - 1, arg_dst[arg_dst_size - i - 1]);
    }
...
void Test_CF_MemcpyFromBE_WhenBoth_src_size_And_dst_size_Eq_1_CopyOne_src_Value(void)
{
    ...
    UtAssert_True(memset_context.__c == 0, "memset __c is %d and should be 0", memset_context.__c);
    UtAssert_True(memset_context.__n == arg_dst_size, "memset __n is %d and should be %d (dst_size)",
...
void Test_CF_MemcpyFromBE_When_src_size_IsLessThan_dst_size_CopyAllRequisite_src_ValuesInto_dst(void)
{
    ...
    int   arg_src_size = Any_uint8_LessThan(arg_dst_size - 1) +
                       1; /* Any_uint8_LessThan(arg_src_size - 1) + 1 give min of 1, max of 1 less than arg_src_size */
    uint8 i;
    ...
    for (i = 0; i < arg_src_size; ++i)
    {
        UtAssert_True(arg_dst[arg_src_size - i - 1] == arg_src[i],
                      "Correct value copied from arg_src[%u] (%u) to arg_dst[%u] (%u)", i, arg_src[i],
                      arg_src_size - i - 1, arg_dst[arg_src_size - i - 1]);
    }
...
void add_CF_GetMemcpySize_tests(void)
{
    ...
    UtTest_Add(Test_CF_GetMemcpySize_WhenGivenSizeIs_1_AndGiven_num_Uint8Is_0_Return_1, cf_cfdp_helpers_tests_Setup,
               cf_cfdp_helpers_tests_Teardown,
               "Test_CF_GetMemcpySize_WhenGivenSizeIs_1_AndGiven_num_Uint8Is_0_Return_1");
    UtTest_Add(Test_CF_GetMemcpySize_WhenGivenSizeIsAny_int_AndNumsAreAll_0_Return_1, cf_cfdp_helpers_tests_Setup,
               cf_cfdp_helpers_tests_Teardown, "Test_CF_GetMemcpySize_WhenGivenSizeIsAny_int_AndNumsAreAll_0_Return_1");
    ...
    UtTest_Add(
        Test_CF_GetMemcpySize_WhenGiven_num_ElementsAre_0_FromGiven_size_UntilAnotherElementInArrayIsNonZeroReturnThatElementsIndexPlus_1,
        cf_cfdp_helpers_tests_Setup, cf_cfdp_helpers_tests_Teardown,
        "Test_CF_GetMemcpySize_WhenGiven_num_ElementsAre_0_FromGiven_size_"
        "UntilAnotherElementInArrayIsNonZeroReturnThatElementsIndexPlus_1");
...
void add_CF_MemcpyToBE_tests(void)
{
    ...
    UtTest_Add(Test_CF_MemcpyToBE_Asserts_src_size_EqTo_0, cf_cfdp_helpers_tests_Setup, cf_cfdp_helpers_tests_Teardown,
    ...
    UtTest_Add(Test_CF_MemcpyToBE_Asserts_dst_size_EqTo_0, cf_cfdp_helpers_tests_Setup, cf_cfdp_helpers_tests_Teardown,
    ...
    UtTest_Add(Test_CF_MemcpyToBE_Asserts_both_src_size_And_dst_size_Are_0, cf_cfdp_helpers_tests_Setup,
               cf_cfdp_helpers_tests_Teardown, "Test_CF_MemcpyToBE_Asserts_both_src_size_And_dst_size_Are_0");
    ...
    UtTest_Add(Test_CF_MemcpyToBE_WhenBoth_src_size_And_dst_size_Eq_1_CopyOne_src_Value, cf_cfdp_helpers_tests_Setup,
               cf_cfdp_helpers_tests_Teardown,
...
{
    /* NOTE: commented out tests should be added if they are able to be - see the tests */
    UtTest_Add(Test_CF_MemcpyFromBE_Asserts_src_size_EqTo_0, cf_cfdp_helpers_tests_Setup,
               cf_cfdp_helpers_tests_Teardown, "Test_CF_MemcpyFromBE_Asserts_src_size_EqTo_0");
    // UtTest_Add(Test_CF_MemcpyFromBE_Asserts_src_size_LessThan_0,
    //      cf_cfdp_helpers_tests_Setup, cf_cfdp_helpers_tests_Teardown,
    //      "Test_CF_MemcpyFromBE_Asserts_src_size_LessThan_0");
    UtTest_Add(Test_CF_MemcpyFromBE_Asserts_dst_size_EqTo_0, cf_cfdp_helpers_tests_Setup,
               cf_cfdp_helpers_tests_Teardown, "Test_CF_MemcpyFromBE_Asserts_dst_size_EqTo_0");
    // UtTest_Add(Test_CF_MemcpyFromBE_Asserts_dst_size_LessThan_0,
    //      cf_cfdp_helpers_tests_Setup, cf_cfdp_helpers_tests_Teardown,
    //      "Test_CF_MemcpyFromBE_Asserts_dst_size_LessThan_0");
    UtTest_Add(Test_CF_MemcpyToBE_Asserts_dst_size_IsLessThan_src_size, cf_cfdp_helpers_tests_Setup,
               cf_cfdp_helpers_tests_Teardown, "Test_CF_MemcpyToBE_Asserts_dst_size_IsLessThan_src_size");
    UtTest_Add(Test_CF_MemcpyFromBE_WhenBoth_src_size_And_dst_size_Eq_1_CopyOne_src_Value, cf_cfdp_helpers_tests_Setup,
               cf_cfdp_helpers_tests_Teardown,
...
{
    UtTest_Add(Test_CF_SetVariableHeader_Call_FSV_Twice, cf_cfdp_helpers_tests_Setup, cf_cfdp_helpers_tests_Teardown,
               "Test_CF_SetVariableHeader_Call_FSV_Twice");
} /* end add_CF_SetVariableHeader_tests */

void add_CF_HeaderSize_tests(void)
{
    UtTest_Add(Test_CF_HeaderSize_AssertsWhen_eid_l_IsNotGreaterThan_0, cf_cfdp_helpers_tests_Setup,
